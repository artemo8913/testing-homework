...
Запускал на windows, node v16.20.1. В нескольких терминалах запускал команды: $env:BUG_ID = 'a'; npm run start и $env:BUG_ID = 'a'; npm run test. Менял bug_id от 1 до 10. Букву "a" пишу для запуска без багов (при нуле почему-то у меня не запустилось вовсе). Раньше с тестами особо не ставлкивался, времени хватило поразбираться в основном с Гермионой и совсем чуть-чуть с jest.
Телега:
https://t.me/artemo8913
